...
const Level2 = () => {
  ...
  <Navbar FirstNav='none' />            <div className="container pt-5 pb-5">
                <div className="row justify-content-center text-center">
                    <h3 className='font-36 font-500 cocon Refertextcolor'>Refer a friend!  Earn 0.5% upon 3 month</h3>
                        ...
                        <div className='boxshado rounded-3 p-lg-5 p-md-4 p-4 mt-4 '>
                            ...
                            <div className='mt-lg-5 mt-md-3 mt-2'>
                                ...
                                <div className="input-group mb-3 mt-2">
                                    <input type="text" className="form-control orderinput p-2 poppins" placeholder="voucherify.io"/>
            ...
            <div className="container pt-5 pb-5">
                <div className="row justify-content-center text-center">
                    <h3 className='font-36 font-500 cocon Refertextcolor'>
                        Level 2 Referral Bonus: Earn 25 Bonus Bids!
                    </h3>
                    <div className="col-lg-6 col-md-6 col-12">
                        <div className='boxshado rounded-3 p-lg-5 p-md-4 p-4 mt-4'>
                            <h6 className='inter font-16 font-500 Refertextcolor'>
                                Invite your extended network and earn an indirect bonus of 25 bids upon successful referrals.
