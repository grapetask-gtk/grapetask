      ...
      <div className="container pt-5 pb-5">
        <div className="row justify-content-center text-center">
          <h3 className="font-36 font-500 cocon Refertextcolor">
            Thanks a friend and get 0.3% upon 3 months
          </h3>
          <div className="col-lg-6 col-md-6 col-12">
            <div className="boxshado rounded-3 p-lg-5 p-md-4 p-4 mt-5 ">
              <h6 className="font-16 font-500 inter thankstextcolor">
                Your friend understands that you are very good at this job,
                which is why they referred you.
              </h6>
              ...
              <div className="form-check colororing text-start">
                ...
                />
                <label
                  className="form-check-label colorgray text-start"
                  for="gridCheck"
                >
                  I agree to{" "}
                  <span className="font-16 font-600 poppins text-decoration-underline">
                    Term & Conditions
                  </span>
                </label>
              </div>
