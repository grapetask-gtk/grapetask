...
import earning from '../assets/total-earning.png'
            ...
            <div className="container-fluid mt-4   p-lg-5 p-md-5 p-sm-4 p-3 pt-5">
                <div className="row pb-2">
                    ...
                    <div className='text-end'>
                        <span className='p-2 rounded-3 colororing font-14 poppins fw-semibold' style={{ backgroundColor: '#F5F5FF' }}>

                            <img src={earning} width={28} className='me-2' height={19} alt="w8" />Total Earning ${userDetail?.referral_earning}
                ...
                <div className="row  boxshado mt-4 p-3 bg-white">
                    ...
                    <div className='d-flex justify-content-end hireexpert mt-3'>
                        <Stack spacing={4}>
                            <Pagination count={myReferrals.length} variant="outlined" shape="rounded" />
                        </Stack>
                    </div>
                </div>
