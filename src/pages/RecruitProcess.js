  ...
  return (
    <>
      ...
      <div className="container-fluid pt-5 p-5 poppins">
        <div className="row">
          <h6 className="byerLine font-28 font-500 cocon blackcolor">
            Skill Test
          </h6>
...
<<<<<<< HEAD
        ...
        <div className="row justify-content-center pt-5">
              ...
              <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                  <h2 className="accordion-header">
                    <button
                      className="accordion-button collapsed haifwhitecolor"
                      type="button"
                  ...
                  >
                    <div className="accordion-body ">
                      <Link to="/tack" className="text-black">
                        Business funding in which companies sell their unpaid
                        invoices.
                      </Link>
                    </div>
                  </div>
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header">
                    <button
                      className="accordion-button collapsed haifwhitecolor mt-3"
                      type="button"
                      data-bs-toggle="collapse"
          ...
          <div className="col-lg-6 col-md-6 col-sm-11 col-12 mt-lg-0 mt-md-3 mt-3">
            <div className="background p-4 rounded-3">
              <h6>Programing</h6>
...
<<<<<<< HEAD
          ...
          <div className="col-lg-6 col-md-6 col-sm-11 col-12 mt-lg-5 mt-md-3 mt-3">
            <div className="background p-4 rounded-3">
