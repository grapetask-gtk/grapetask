...
import { FaFolderOpen, FaPenNib, FaStar, FaHandshake, FaPalette, FaAngleLeft, FaAngleRight } from 'react-icons/fa'
  ...
  return (
    <>
      ...
      <section className='herosection d-flex align-items-center py-lg-0 py-md-0 py-5' >
        ...
        <div id="carouselExampleFade" className="carousel slide carousel-fade h-100 w-100 d-lg-block d-md-block d-none" style={{ objectFit: 'cover', position: 'absolute', zIndex: '-1' }}>
          <div className="carousel-inner h-100">
            <div className="carousel-item active h-100">
              <div className="container-fluid p-0 poppins h-100">
                <video width={'100%'} height={'100%'} style={{ objectFit: 'cover' }} muted loop autoPlay >
        ...
        <div className="container-fluid  p-lg-5 p-md-4 p-3">
          ...
          <div className="row justify-content-center text-center">
            <div className="col-lg-8 col-12">
              <h3 className='font-70 font-500 cocon' style={{ color: "white" }}>Find the Business of <br />your <span className='colororing'>Dreams</span> </h3>
              <p className=' font-18 text-white poppins'>Find You New Job Today! New Job Postings Everyday just for you, browse the job you want and apply wherever you want</p>
              <div className="row  justify-conten-center mt-2 poppins position-relative " style={{ zIndex: '99' }} >

                <form className="col-12 border-box pt-3 align-items-center  justify-content-around pb-3  hero-input"
                  ...
                  <div className=" d-flex align-items-center hero_Search_Field" >
                    ...
                    <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} className='border-0 ms-2 w-100 font-16 poppins' placeholder='Job title or keyword' required />
                  </div>
                  <img src={Line} width={4} height={30} className='d-lg-flex d-md-flex d-sm-flex d-none' alt="w8" />
                  <div className=" d-flex align-items-center hero_Search_Field mt-lg-0 mt-md-0 mt-sm-0 mt-3" >

                    <div><GoLocation size={20} color='#F16336' /></div>
                    <input type="text" value={location} onChange={(e) => setLocation(e.target.value)} className='border-0 ms-3 w-100 font-16' placeholder='Canada, Ontario' required />
                  </div>
                  <div className=" mt-lg-0 mt-md-0 mt-sm-0 mt-3">
                    <Button type='submit' className='btn-stepper  rounded-5 poppins px-3  font-16'>Search</Button>
                  </div>
      ...
      <div className="container-fluid d-lg-none d-md-none d-block">
        <div className="row justify-content-center p-0">
          <Slider {...settings}>
            <div className="col-sm-10 col-12 mbl-videoModal position-relative p-0" data-bs-toggle="modal" data-bs-target="#videoModal">
      ...
      <div div className="container-fluid esaysection position-relative pt-lg-5 pt-md-4 pt-3" >
        <img src={done} className='w-100 position-absolute doneimg' alt="" />

        <div className='d-flex justify-content-center flex-column mt-5'>
          <h3 className='text-center font-28 cocon'>GrapeTask simplifies the process of task completion.</h3>
        ...
        <div className="row justify-content-center mt-5 px-3 pb-lg-0 p-md-0 p-0  poppins">
          <div className="col-lg-4 col-md-4 col-sm-6 col-12">
            <Grapetask imges={post} heading='Make a Job Posting' para='There are many variations of 
            passagesof Lorem Ipsum,'/>
          </div>
          <div className="col-lg-4 col-md-4 col-sm-6 col-12 mt-lg-5 mt-md-5 mt-4">
            <Grapetask imges={hire} heading='Hire FreeLancers' para='There are many variations of 
           passagesof Lorem Ipsum,'/>
          </div>
        </div>
        <div className="row justify-content-center  px-3 pb-lg-0 p-md-0 p-0 poppins">
          ...
          <div className="col-lg-4 col-md-4 col-sm-6 mt-lg-0 mt-md-0 mt-sm-0 mt-4 col-12">
            <Grapetask imges={get} heading='Accomplish Tasks' para='There are many variations of 
            passagesof Lorem Ipsum,'/>

          </div>
          <div className="col-lg-4 col-md-4 col-sm-6 col-12  mt-lg-5 mt-md-5 mt-4">
            <Grapetask imges={make} heading='Payment Assurance' para='There are many variations of passagesof Lorem Ipsum,' />
      ...
      <div className="container-fluid p-lg-5 p-md-5 p-sm-4 p-3 ">
        ...
        <div className="row poppins justify-content-center ">
          <div className="col-lg-6 col-md-6 col-12 d-flex justify-content-lg-start justify-content-md-center justify-content-center"><img src={goodcmpny} className='w-75' alt="" /></div>
          <div className="col-lg-6 col-md-6 col-12 align-self-center">
            <h1 className='fw-normal font-38'>This is How <span className='colororing'> Good Companies
              Find Good Company.</span></h1>
                ...
                <div className="col-lg-10 col-12 mt-4">
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className='font-18 mb-0' style={{ color: 'rgba(102, 112, 133, 1)' }}>Access expert talent to fill your skill gaps</p>
                    </div>
                  ...
                  <div className='row mt-3'>
                    ...
                    <div className="col-10">
                      ...
                      <p className='font-18 mb-0' style={{ color: 'rgba(102, 112, 133, 1)' }}>Control your workflow: hire, classify and pay your talent</p>
                    </div>
                  </div>
                  <div className='row mt-3'>
                    <div className='col-2 d-flex justify-content-center'>
                    ...
                    <div className="col-10">
                      ...
                      <p className='font-18 mb-0' style={{ color: 'rgba(102, 112, 133, 1)' }}>Partner with Companies for end-to-end support</p>
                    </div>
                  </div>
                </div>
            ...
            <button type='button ' onClick={() => navigate('/aboutus')} className='btn-fill mt-4 ms-lg-2 ms-md-2 ms-sm-2 ms-0 font-16'>Learn more</button>
          </div>
        </div>
      </div>
      {/* ------------TOP--RATED---SALLER------------ */}
          ...
          <div className="row justify-content-between  h-100 ">
            <div className="col-lg-6 mt-lg-0 mt-4 col-12 d-flex align-items-center h-100">
              <div className='w-100'>
                ...
                <h1 className='cocon font-30  fw-semibold text-white'>Meet Our <span className='colororing'> Top-Rated</span> Freelancers</h1>
                <form className="border-box px-3 pt-3 align-items-center d-flex justify-content-between pb-3  hero-input">
                  <input type="text" value={topRated} onChange={(e) => setTopRated(e.target.value)} className='border-0 ms-2 w-100 font-16 poppins' required placeholder='What are you looking for?' />
                  <div className="">
                    <Button type='submit' onClick={handleTopRatedFreelancer} className='btn-stepper  rounded-5 poppins px-3  font-16'>Search</Button>
                  </div>
                </form>
              </div>
            </div>
      ...
      <div className="container-fluid  position-relative mt-5 p-lg-5 p-md-5 p-sm-4 p-3">
        <img src={choose} className=' position-absolute chooseimg end-0' alt="" />
          ...
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9'><h6 className='font-20'>Marketing &<br />
                  Communication</h6>
                  <p className='mb-0 font-14' >58 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9 '><h6 className='font-20'>
                  UI / UX <br />Design</h6>
                  <p className='mb-0 font-14' >120 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9 '><h6 className='font-20'>Finance <br />
                  Management</h6>
                  <p className='mb-0 font-14' >230 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9   '><h6 className='font-20'>Web
                  <br />
                  Development</h6>
                  <p className='mb-0 font-14' >100 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9'><h6 className='font-20'> Project

                  <br />
                  Management</h6>
                  <p className='mb-0 font-14' >87 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9'><h6 className='font-20'>Business &


                  <br />
                  Consulting</h6>
                  <p className='mb-0 font-14' >23 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9'><h6 className='font-20'>Graphic

                  <br />
                  Designer</h6>
                  <p className='mb-0 font-14' >65 Jobs Available</p></div>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2">
            <div className="container-fluid h-100">
              ...
              <div className='row mycard p-3 align-items-center h-100'>
                ...
                <div className='col-9'><h6 className='font-20'>Video
        ...
        <div className="container-fluid d-lg-none d-md-none d-sm-none d-block index-bootstrap-carousel  bootstrap-carousel ">
          <div class="row">
            ...
            <div className="col-lg-3 col-md-6 col-12 mt-lg-5 mt-md-4 mt-sm-3 mt-2" style={showLess ? { display: 'block' } : { display: 'none' }}>
              <div className="container-fluid h-100">
            ...
            <div class="col-12 mt-2 text-center">
              <h4 onClick={handleShowLess} style={{ cursor: 'pointer' }}>{showLess ? 'Show less' : 'Show more'}</h4>
            </div>
          </div>
        </div>
      ...
      <div className="container-fluid p-lg-5 p-md-5 p-sm-4 p-3 mt-4 position-relative overflow-hidden">
        ...
        <h3 className='text-center font-28 font-500 cocon'>Make it Real with Freelancer.</h3>
        <div className='d-flex justify-content-center'>
          <img src={line} className='text-center' alt="" />
        </div>
          ...
          <div className="container-fluid">
            ...
            <div className="row d-flex justify-content-center">
              ...
              <div className=' col-lg-2 col-md-3 col-sm-4 col-10  poppins'>
                ...
                <Button type='button ' onClick={() => navigate('/search/gigs')} className='btn-stepper mt-lg-5 mt-md-4 mt-3 px-4 py-2'>View all</Button>
          ...
          <div className="row justify-content-center ">
            <div className="col-lg-6 col-md-6 col-12 d-flex align-items-center">
              <div>
                ...
                <h3 className='font-28 font-500 cocon'>A whole world of freelance
                  talent at your fingertips</h3>
                <div className='mt-3'>
                  <div className='mt-4 d-flex '>
                    <img src={quality} width={30} height={39} alt="" />
                    <div className='ms-3'>

                      <h5 className='font-20'><span></span>Proof of Quality</h5>
                      <p className='font-16'>Check any pro’s work samples, client reviews, and
                  ...
                  <div className='mt-4 d-flex'>
                    ...
                    <div className='ms-3'>
                      ...
                      <h5 className='font-20'><span></span>No cost until you hire</h5>
                      <p className='font-16'>Check any pro’s work samples, client reviews, and
                        identity verification.</p>
                    </div>
                  </div>
                  <div className='mt-4 d-flex'>
                    ...
                    <div className='ms-3'>
                      ...
                      <h5 className='font-20'><span></span>Safe and secure</h5>
                      <p className='font-16'>Check any pro’s work samples, client reviews, and
                        identity verification.</p>
                    </div>
                  </div>
                  <div className='mt-4 d-flex'>
                    ...
                    <div className='ms-3'>
                      ...
                      <h5 className='font-20'><span></span>Freelancer-friendly interface</h5>
                      <p className='font-16'>Check any pro’s work samples, client reviews, and
                        identity verification.</p>
                    </div>
                  </div>
            ...
            <div className="col-lg-6 col-md-6 col-12 position-relative">
              <div className='text-end'>
                <img src={client} className='imgwhrd' width={'70%'} alt="w8 not found" />
              </div>
              <div className='chakimgesbox'>
                <div className='d-flex '>
                  <img src={cheack} width={20} height={20} className='me-4' alt="w8 not found" />
                ...
                <div className='d-flex '>
                  <img src={cheack} width={20} height={20} className='me-4' alt="w8 not found" />
                  <p className='font-16'>Protected payments, every
                    time </p>
                </div>
                <div className='d-flex '>
                  <img src={cheack} width={20} height={20} className='me-4' alt="w8 not found" />
      ...
      <div className="container subrib d-flex align-items-center" id='subscribe'>
        <div className="row px-4">
          <div className="col-lg-6 col-md-6 col-12 px-lg-4 px-3">
            <h1 className='poppins font-40 text-white fw-semibold'>Never Want to Miss
              Any Job News?</h1>
          </div>
            ...
            <div className="row justify-conten-center mt-2 poppins position-relative " >
              ...
              <div className="col-lg-10 col-md-12 border-box pt-3 align-items-center d-flex justify-content-around pb-3  hero-input">
                ...
                <div className=" d-flex align-items-center w-100" >
                  <input type="text" value={email} onChange={(e)=>setEmail(e.target.value)} className='border-0  w-100 font-16' placeholder='Enter your email address here...' />
                </div>
                <img src={Line} width={4} height={30} alt="w8" />

                <div className="ms-3">
                  <button type='button' disabled={subscribeLoader} onClick={submitNewsLetter} className='btn-circl rounded-5 font-16'>
                  {subscribeLoader ? <Spinner size="sm" color="light" /> : 'Subscribe'}</button>
                </div>
