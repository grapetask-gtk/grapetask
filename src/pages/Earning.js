...
import imagarrow from '../assets/imgarrow2.png'
import imagarrow1 from '../assets/imgarrow.png'
import imagarrow2 from '../assets/imgarrow1.png'
...
import arrow from '../assets/chartArrow.png'
  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="custom-tooltip  rounded-3 p-1 px-2 border-0 " style={{ backgroundColor: 'black' }}>
        ...
        <p className="label mb-0 text-white poppins font-12 fw-semibold"><span><img src={arrow} className='me-2' width={18} height={9} alt="w8 " /></span>{`${uvValue}`}%</p>
      </div>
    );
  }
...
const CustomTick = (props) => {
  ...
  return (
    <text x={x} y={y + 10} fontSize="12" className='poppins fw-medium' textAnchor="middle" fill="#4F4F4F">
      {payload.value}
    </text>
  );
};
        ...
        <div className="row mx-lg-4 mx-md-3 mx-xm-3 mx-0">
          ...
          <div className="col-lg-8 col-12 mt-lg-0 mt-4">
            <div className='d-flex justify-content-between'>
              <div>
                <h3 className='byerLine font-22 font-500 cocon blackcolor'>Earning Orders</h3>
              </div>
              <div>
                <div>
                  <Button className='btn-stepper poppins px-3  font-16'>Withdraw Balance</Button>
                </div>
                <Link to="/payoutMethod" className='colordark font-14 text-decoration-underline poppins'>Manage payout methods</Link>
              </div>
            </div>
            <div className='Revie mt-3'>
                ...
                <div className='row bgcolor p-4'>
                  <div className="col-lg-4 col-md-4 col-sm-4 col-12 mt-lg-0 mt-md-0 mt-sm-0 mt-3 px-2">
                    <div className='d-flex align-items-center'>
                      <div><img src={imagarrow} width={80} height={80} alt="" /></div>
                      <div className='ms-2'>
                        <p className='font-14 font-500 poppins mb-0 textgray'>Total Earning</p>
                        <h3 className='font-26 font-500 poppins blackcolor'>${userDetail?.referral_earning}</h3>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-4 col-12 mt-lg-0 mt-md-0 mt-sm-0 mt-3 px-2">
                    <div className='d-flex align-items-center'>
                      <div><img src={imagarrow1} width={80} height={80} alt="" /></div>
                      <div className='ms-2'>
                        <p className='font-14 font-500 poppins mb-0 textgray'>Balance</p>
                        <h3 className='font-26 font-500 poppins blackcolor'>$0</h3>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-4 col-12 mt-lg-0 mt-md-0 mt-sm-0 mt-3 px-2">
                    <div className='d-flex align-items-center'>
                      <div><img src={imagarrow2} width={80} height={80} alt="" /></div>
                      <div className='ms-2'>
                        <p className='font-14 font-500 poppins mb-0 textgray'>Total Sales</p>
                        <h3 className='font-26 font-500 poppins blackcolor'>$ 0</h3>
              ...
              <div className='bgcolor p-4 mt-3'>
                <div className='d-flex justify-content-between chart-headings '>
                  ...
                  <select className="form-select border-0 font-12" aria-label="Default select example">
                ...
                <div style={{ width: '100%' }}>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart width={150} height={40} data={ALLdata}>
                      ...
                      <XAxis dataKey="name" tick={<CustomTick />} interval={0} axisLine={false} />
                      <Bar dataKey="uv">
              ...
              <div className='mt-lg-4 mt-md-3 mt-2'>
                <h3 className='byerLine font-22 font-500 cocon blackcolor'>Rating & Reviews</h3>
                <div className="Revie">
