...
import img1 from '../assets/Client-logo1.png'
import img2 from '../assets/Client-logo2.png'
import img3 from '../assets/Client-logo3.png'
import img4 from '../assets/Client-logo4.png'
import img5 from '../assets/Client-logo5.png'
  ...
  return (
    <>
      ...
      <div className="container-fluid px-lg-5 px-md-5 px-sm-4 px-3 pt-lg-5 pt-md-4 pt-2 mt-lg-5 mt-md-4 mt-3 poppins  mb-lg-5 mb-md-4 mb-3">
        <div className="row">
          <div className="col-lg-6 col-md-6 col-12"><img src={busnis} className='w-100 rounded-4' alt="" /></div>
          <div className="col-lg-6 col-md-6 col-12">
            <p className='colororing font-16'> Criminal Law, Kidnapping   |   Sunday, July 24, 2022   </p>
            <hr style={{ opacity: '1', backgroundColor: '#3A4553' }} />
            <h4 className='font-28 font-600'>An Independent Examination Of <br />
              Charity Accounts</h4>
            <p className='font-18 takegraycolor'>There are  of Lorem Ipsum available, but the majority have su alteration in some form, by injected oir  which don't look even slightly believable.</p>
            <a href="" className='colororing font-16'>Read More</a>
          </div>
        </div>
      </div>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-md-6 col-12">
            ...
            <div className=" mt-3 mb-3 d-flex justify-content-between colororing">
              <p className='mb-0 font-16'>Legal Advice&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Sunday, July 24, 2022</p></div>

            <div className=''>
              <hr style={{ opacity: '1', backgroundColor: '#3A4553' }} />
              <h6 className='font-20 font-600'>An Independent Examination Of <br />
                Charity Accounts</h6>
              ...
              <Link to="/Blogopen" >
                <p className='colororing font-16'>Read More</p></Link>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 col-12">
            <img src={loptop} className='w-100 rounded-3' alt="" />
