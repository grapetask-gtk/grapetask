...
export default function IncomeAreaChart({ view }) {
  ...
  const fallbackColor1 = theme.palette.primary.main || '#1976d2'; // Fallback to default color
  const fallbackColor2 = theme.palette.primary[700] || '#1565c0'; // Fallback to default color
      ...
      >
        <defs>
          <linearGradient id="myGradient1" gradientTransform="rotate(90)">
            <stop offset="10%" stopColor={alpha(fallbackColor1, 0.4)} />
            <stop offset="90%" stopColor={alpha(theme.palette.background.default, 0.4)} />
          </linearGradient>
          <linearGradient id="myGradient2" gradientTransform="rotate(90)">
            <stop offset="10%" stopColor={alpha(fallbackColor2, 0.4)} />
            <stop offset="90%" stopColor={alpha(theme.palette.background.default, 0.4)} />
          </linearGradient>
        </defs>
      </LineChart>
