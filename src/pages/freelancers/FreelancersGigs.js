...
const FreelancersGigs = () => {
  ...
  const filterByType = useCallback((array, targetType) => {
  ...
  const handlePackageSelection = useCallback((packageId) => {
    if (!singleGigDetail?.user?.id || !singleGigDetail?.id) return;
    
    navigate(
      `/order/payment?seller_id=${singleGigDetail.user.id}` +
  ...
  const NextArrow = (props) => (
    <div className="arrow-next rounded-5" onClick={props.onClick}>
      <FaAngleRight />
    </div>
  );

  const PrevArrow = (props) => (
    <div className="arrow-prev rounded-5" onClick={props.onClick}>
      <FaAngleLeft />
    </div>
  );
    ...
    return (
      <div>
        <div className="d-flex justify-content-between poppins">
          <h6 className="font-16 fw-semibold" style={{ color: '#404145' }}>
            {type.toUpperCase()} PROMO
          </h6>
          <h6 className="graycolor font-16 fw-semibold" style={{ color: '#404145' }}>
            ${packageData.total}
          </h6>
        </div>
        <div className="mt-3">
        ...
        <div>
          ...
          <p className="font-12" style={{ color: '#95979D' }}>
            <FaCheck className="colororing me-3" /> 5 screenshots
          </p>
          <p className="font-12" style={{ color: '#95979D' }}>
            <FaCheck className="me-3" color="#95979D" /> Screen recording
          </p>
          <p className="font-12" style={{ color: '#95979D' }}>
            <FaCheck className="colororing me-3" /> Add logo
          </p>
          <p className="font-12" style={{ color: '#95979D' }}>
            <FaCheck className="me-3" color="#95979D" /> Dynamic transitions
          </p>
          <p className="font-12" style={{ color: '#95979D' }}>
            <FaCheck className="colororing me-3" /> 30 seconds running time
          </p>
        </div>
        <div>
          <Button
    ...
    return (
      ...
      >
        ...
        <div className="offcanvas-body pe-0">
          <h6 className="font-28 fw-semibold" style={{ color: '#404145' }}>
            Service Details
          </h6>
  ...
  return (
    <>
        ...
        <div className="row mt-3 justify-content-center">
          <div className="col-lg-8 col-12 mt-4">
            <div className="Revie p-3">
              <div>
                <h3 className="font-24 poppins">{singleGigDetail?.title}</h3>
              </div>
              ...
              <div className="mt-2 poppins">
                ...
                <p className="font-14 mb-1 dark-gray">
                  {stripHtmlTags(singleGigDetail?.description)}
                </p>
                <hr
                ...
                <div className="row justify-content-between">
                  ...
                  <div className="col-6">
                    ...
                    <p className="font-14 fw-bold dark-gray">about 3 hours</p>
                  </div>
                </div>
                <hr
                  className="border-0 mt-1 mb-1"
                  ...
                  <div className="mt-3" key={index}>
                    ...
                    <div className="d-flex justify-content-end align-items-center">
                      ...
                      <p className="font-14 ms-1 fw-medium takegraycolor mb-0">
                        {formatDistanceToNow(new Date(value.created_at || new Date()), {
                          addSuffix: true,
                        })}
                      </p>
                    </div>
      ...
      {/* Package Offcanvases */}
      {renderPackageOffcanvas('Basic', filteredBasic, handleBasic)}
      {renderPackageOffcanvas('Standard', filteredStandard, handleStandard)}
      {renderPackageOffcanvas('Premium', filteredPremium, handlePremium)}
