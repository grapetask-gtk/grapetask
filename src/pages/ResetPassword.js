                            ...
                            <div className="row justify-content-center login-right-side">
                                <div className="col-lg-10 col-md-10 col-12 ">
                                    ...
                                    <div className="row mt-2">
                                        <h3 className='mt-3  cocon colororing'>Reset your Password</h3>
                                    </div>

                                    <form class="col-lg-12 col-md-12 col-12 mt-lg-3 mt-md-2 mt-2" onSubmit={handleSubmit}>
                                        <ToastContainer />

                                        <label htmlFor="new" className='font-14 fw-medium'>New Password</label>
                                        <input type="password" id='new' className="form-control input-field p-3 mt-2" required
                                            value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                                        <label htmlFor="confirm" className='font-14 mt-3 fw-medium'>Confirm Password</label>

                                        <input type="password" id='confirm' className="form-control input-field p-3 mt-2" required
