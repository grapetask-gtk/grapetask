                            ...
                            <div className="row justify-content-center me-lg-5 me-md-5 login-right-side">
                                <div className="col-lg-8 col-md-8 col-12 ">
                                    ...
                                    <form className="row mt-2" onSubmit={handleSubmit}>
                                        ...
                                        <p className='mt-3 font-14 mb-0' style={{ color: 'rgba(148, 148, 148, 1)' }}>Enter code that you have received on email</p>
                                        ...
                                        <button type='submit ' loading={true} disabled={isLoading} className={` mt-4 ms-2 ${otp ? 'otp-btn' : 'otp-btn-border'}`}>
                                            {isLoading ? <Spinner size="sm" color="light" /> : 'Verify'}
                                        </button>
                                    </form>
