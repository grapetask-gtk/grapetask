...
const ProfileOtherPerson = () => {
  ...
  const overallAverageFive = (filterRatingFive?.length / userallRating?.length) * 100;
  // console.log(overallAverageFive,'=====filter 5');
  // Average value 4
  const filterRatingFour = userallRating.filter((value) => value == 4);
  const overallAverageFour = (filterRatingFour?.length / userallRating?.length) * 100;
        ...
        <div className="row">
          <div className='Revie'>
            <div className='text-center'>
              <img src={userGigs?.image ? userGigs.image : emptyProfile} className='rounded-circle ' width={120} height={120} alt="w8" />

              <div>
                <a  >
                  <h6 className='font-22 font-500 poppins mt-3' >{userGigs?.fname}</h6>
                </a>
        ...
        <div className='mt-lg-5 mt-md-3 mt-2'>
          ...
          <div className='Revie mt-lg-4 mt-md-3 mt-2'>
            <div className='d-flex justify-content-between'>
              ...
              <div><p className='font-18 font-500 poppins'>4</p></div>
            </div>
            <hr />
            <div className='d-flex justify-content-between'>
              <div><p className='font-18 font-500 poppins'>Earned in May </p></div>
              <div><p className='font-18 font-500 poppins'>$300 </p></div>
            </div>
          </div>
        </div>
        <div className='mt-lg-5 mt-md-3 mt-2'>
...
<div className="container-fluid">
  ...
  userGigs.gigs?.map((value, index) => (
                <div className="col-lg-4 col-md-4 col-sm-6 col-12  mt-4"  onClick={() =>
                  navigate(`/freelancersGigs/${value.id}`)
                } key={index}>
   ...
   <div className="mt-5">
              ...
              <div className="Revie">
                ...
                {userRatingDetain.length >0
                  ...
                  : <h3 className="cocon mt-4 text-center">Not Found Comments</h3>}
