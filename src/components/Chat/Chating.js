                ...
                <div className="card h-100 justify-content-between  ">
                 <div >
                        {/* <div>
                            <div className="p-3">
                                ...
                                <div className="rounded-3 p-3" style={{ backgroundColor: '#F5F5FF' }}>
                                    <p className="font-16 blackcolor mb-1">Kah Tung Yong, Legends Technology</p>
                        ...
                        <div className="scroll px-3 ">
                                        ...
                                        return (
                                            <div className="d-flex justify-content-start mb-4 position-relative  p-3 user-msg">
                                                ...
                                                <div className="msg_cotainer pe-lg-3 pe-md-3 pe-4">
                                                    ...
                                                    <Button type="button" className="px-3 mb-lg-3 font-14">View Deatail</Button>
                                                </div>
                                                <div ref={scrollRef} />
                                            </div>
                                        );
                            ...
                            <h3 className="mt-5">Please Select any Chat to view messages</h3>
                        ...
                        <div className="card-footer pt-0 pb-0 border-0 rounded-3 position-relative">
                            <div className="call-option">
                                <div>
                                    ...
                                    <img src={videos} width={30} height={30} style={{cursor:'pointer'}} onClick={handlevideo} alt="w8" />
                                </div>
                                <img src={voice} width={30} className="mt-2" height={30} alt="w8" />
                            </div>
