...
import emptyProfile from '../../assets/AfterUpload.png'
import emptyProfileModal from '../../assets/emptyProfileModal.png'
      ...
      <div className=" highT sidebar-profile poppins">
        <div className="userImg-selection d-flex flex-column justify-content-center align-items-center">
          <div>
            ...
            <div>
              <div className='d-flex justify-content-center'>
                ...
                <div style={{
                  ...
                  <img src={userDetail ? userDetail.image : emptyProfile} className='w-100 h-100 rounded-circle 
                  ' alt="w8" />
              ...
              <button type='button' className="profile-upload px-3 p-2 mt-4 d-flex align-items-center"
            ...
            >
              <Box className="bg-white rounded-4 p-lg-5 p-md-4 -sm-3 p-2 profile-modal-mbl" sx={style}>
                <div className="border-0">
                  <h1 className="modal-title font-28 cocon" id="staticBackdropLabel">Your Photo</h1>
                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-lg-4 col-md-4 col-12 text-center">
                      ...
                      <img src={selectedImagePreview} className='mt-3 rounded-circle ' width={150} height={150} alt="w8" />
                      <div>
                        {/* <u className='colororing poppins mt-4 font-14 cursor-pointer' onClick={() => setImgPreview(null)} >Delete current image</u> */}
                        <p className="font-16 takegraycolor text-center mt-2">250 x 250 <span className='font-12 takegraycolor'>Min</span></p>

                      </div>
                    </div>
                    <div className="col-lg-8 col-md-8 col-12">
                      <h4 className='poppins font-24 blackcolor' >Present the finest version of yourself
                        to the client.</h4>
                      <p className="font-16 poppins mb-2" style={{ color: '##1D2B3C' }}>Must be an actual photo of you.</p>
                      <p className="takegraycolor font-16 poppins">Logo, group photo, clip art and digitally altered
                        images are not allowed.</p>
                      <div className='d-flex justify-content-end image-upload-after  my-lg-0 my-md-0 my-3' style={{ bottom: '20px', right: '25px' }}>
                        <Button type="button" onClick={(e) => { setModalOne(false); }} className="btn-stepper-border me-3 poppins px-3 p-2 rounded-3 font-16" >Close</Button>
                        <Button
                          className=' btn-stepper poppins  px-3 p-2 rounded-3 font-16 d-flex align-items-center'
                          onClick={isImageSelected ? handleUploadProfilePhoto:handleButtonClick}
                        >
                          {isImageSelected ? 'Upload Photo' :'Click to Attach Photo'}
                        </Button>
        ...
        <div className="mt-5 side-bar-tabs poppins">
          <ul className="container-fluid  ">
            <li className={`list  py-2 font-16 row justify-content-center ${activeTab === 'profile' ? 'active' : ''}`}
            ...
            <li className={`list  py-2 row justify-content-center font-16 ${activeTab === 'MyOrders' ? 'active' : ''}`}
            ...
            <li className='list py-2 font-16 row justify-content-center '
