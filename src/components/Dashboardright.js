...
import Natayla from '../assets/Natayla.png'
import pen from '../assets/pen.png'
import { CircularProgressbar, } from 'react-circular-progressbar';
import doubl from '../assets/doubletick.png'
import doube from '../assets/duble.png'
...
import emptyProfile from '../assets/emptyProfileModal.png'
      ...
      <div className="container">
        <div className="row">
          <div className='Revie'>
            <div className='text-center'>
              <img src={UserData?.image ? UserData?.image : emptyProfile} className='rounded-circle ' width={120} height={120} alt="w8" />

              <div>
                {/* Button trigger modal */}
                <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                  <h6 className='font-22 font-500 poppins mt-3' >{firstName}<span><img src={pen} className='ms-1' width={16} height={16} alt="w8" /></span></h6>
                </a>

              </div>
              {/* <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdropone"> */}
              <p className='font-14 poppins' >{userDetail ? userDetail?.role : ''}</p>
              {/* </a> */}
            </div>
            <div className='d-flex mt-5 pb-5 text-center poppins'>

              <div className='loader1'>
                <CircularProgressbar className='w-75' value={percentage1} text={`${percentage1}%`} />
                <h6 className='mt-3 font-14 poppins blackcolor'>Project Success
                  Ratio</h6>
              </div>
              <div className='loader2'>
                <CircularProgressbar className='w-75' value={percentage2} text={`${percentage2}%`} />
                <h6 className='mt-3 font-14 poppins blackcolor'>Total Order</h6>
              </div>
              <div className='loader3'>
                <CircularProgressbar className='w-75' value={percentage3} text={`${percentage3}%`} />
                <h6 className='mt-3 font-14 poppins blackcolor'>Complete <br />
                  Order</h6>
              </div>
            </div>

            <div className='d-flex justify-content-between'>
              <div><h6 className='font-18 font-500 poppins blackcolor'>Last Activites</h6></div>
              <div><p className='font-16 poppins colororing'>See All</p></div>
            </div>
            <div className='d-flex rounded-4 px-3 mt-2 p-2 align-items-center' style={{ border: '1.5px solid #AC9E9E' }}>
              <div><img src={doubl} width={45} height={45} alt="w8" /></div>
              <div>
        ...
        <div className='mt-lg-5 mt-md-3 mt-2'>
          ...
          <div className=' Revie p-3 mt-lg-4 mt-md-3 mt-2'>
            <div className="text-end">
              <button type='button' className="font-12 poppins colororing border-0" onClick={toggleModal} style={{ backgroundColor: 'transparent' }}><BsFillPencilFill /></button>
            </div>
            ...
            <Modal className='poppins' isOpen={showModal} toggle={toggleModal}>
              ...
              <form className='AddFaqs-step-three'>
                ...
                <ModalFooter className='border-0'>
                  ...
                  <Button onClick={handleTagsAdd} loading={true} disabled={isLoading} className='btn-stepper poppins px-3   font-16' >
            ...
            <>
              {tagsList.map((value, index) => (
                <span className='poppins m-1 rounded-4 haifwhite d-inline-flex' key={index}>
        ...
        <div className='mt-lg-5 mt-md-3 mt-2'>
          ...
          <div className='Revie mt-lg-4 mt-md-3 mt-2'>
            <div className='d-flex justify-content-between'>
              <div><p className='font-18 font-500 poppins blackcolor'> Active orders </p></div>
              <div><p className='font-18 font-500 poppins'>0</p></div>
            </div>
            <hr />
            <div className='d-flex justify-content-between'>
              <div><p className='font-18 font-500 poppins'>Earned in {currentMonth} </p></div>
              <div><p className='font-18 font-500 poppins'>$0 </p></div>
            </div>
          </div>
        </div>
        ...
        <div className="modal-dialog">
          <form onSubmit={handleNameSubmit} className="modal-content">
            ...
            <div className="modal-body">
              <h6 className='font-20 font-500 poppins blackcolor'>Write your display name</h6>
              <p className='font-14 takegraycolor poppins'>Express your identity and personalize your presence by leaving your mark. Write your Job Title here and make a lasting impression.</p>
              <input className="form-control model-input p-3 " type="text" placeholder="Product Designer"
                value={firstName} onChange={(e) => setFirstName(e.target.value)} required />

            </div>
            <div className="modal-footer border-0">
              <Button className='btn-stepper-border poppins me-3 px-3 p-2 rounded-2  font-16 w-auto' data-bs-dismiss="modal">
                Cancel
              </Button>
              <Button type='submit' data-bs-dismiss="modal" className=' btn-stepper poppins  px-3 p-2 rounded-2 font-16 w-auto' >
                Save
              </Button>
            </div>
          </form>
