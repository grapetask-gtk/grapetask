          ...
          <div className="row justify-content-center me-lg-5 me-md-5 login-right-side">
            <div className="col-lg-8 col-md-8 col-12 ">
              ...
              <ToastContainer />
                ...
                <div class=" col-12 mt-4">
                  <input type="password" required className="form-control input-field p-3"
                    value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" aria-label="Password" />
                  {isError &&
                ...
                <div class="col-12 mt-3 ">
                  <div class="form-check colororing">
                    ...
                    <label class="form-check-label colorgray" for="gridCheck">
                      I am agreed with Terms of Service, Privacy Policy, and GrapeTask default Notification Settings.
                    </label>
                  </div>
