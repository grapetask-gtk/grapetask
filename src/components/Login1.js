            ...
            <div className="col-lg-8 col-md-8 col-12 ">
              ...
              <form className="row mt-2" onSubmit={handleSubmit}>
                ...
                <div class=" col-12 mt-4">
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value.toLowerCase())} required className="form-control input-field p-3" placeholder="Email Address" aria-label="Email Address" />
                </div>
                <div class=" col-12 mt-4">
                  <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="form-control input-field p-3" placeholder="Password" aria-label="Password" />
                  <div className='text-end mt-3'><h5 className='cursor-pointer'
                    onClick={() => navigate('/forgot')}>Forgot password</h5></div>
                  {isError &&
                  ...
                  <button type='submit ' loading={true} disabled={isLoading} className='btn-fill mt-4'>
                ...
                <p className='font-15 mt-3 colorgray'>Not a member yet <span data-bs-toggle="modal" data-bs-target="#JoinUSModal" className='colororing cursor-pointer'>SIGNUP HERE</span> </p>
                                            {/* Modal */}
                                                                        ...
                                                                        <div className="col-lg-4 col-md-6 col-sm-6 col-12 mt-5">
                                                                            <div className='cursor-pointer  h-100 outsouces pt-4 pb-4  position-relative '
                                                                                ...
                                                                                <div className='px-4'>
                                                                                    ...
                                                                                    <Link data-bs-dismiss="modal"className='position-relative font-16 z-3'>Get Started &gt;</Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-lg-4 col-md-6 col-sm-6 col-12 mt-5">
